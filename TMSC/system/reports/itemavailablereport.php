            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        $sql2 = "SELECT sum(ja.issueqty) as issueqty,sum(ja.amount * ja.issueqty) as totalamount FROM tbl_jobcardassignitems ja WHERE ja.issuestatus='done' AND ja.catalogid='$catalogid' $where1";
