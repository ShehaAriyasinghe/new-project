...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET' && @$mode == 'assign') {
        ...
        $date = date('Y-m-d');
        $sqltbl = "SELECT j.jobcardid,j.jobcardstatus,j.vehicleid,s.servicename,s.serviceid,v.vehicleid,v.plateno,v.plateimage,v.modelid,v.brandid FROM tbl_jobcards j INNER JOIN tbl_services s ON s.serviceid=j.serviceid INNER JOIN tbl_vehicles v ON v.vehicleid=j.vehicleid  WHERE j.jobcardstatus='issuedjobcard' AND j.deletestatus=1 AND j.reservationdate='$date' AND j.jobcardid='$jobcardid'";
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (empty($technician)) {
            $messages['error_technician'] = "A technician should be selected...!";
        }
        ...
        if (empty($messages)) {
            ...
            $sql = "INSERT INTO tbl_jobcardtechnician(technicianid,jobcardid,adddate,adduser) VALUES ('$technician','$jobcardid','$adddate','$adduser')";
            ...
            header("Location:assign_subservicesjobcard.php?jobcardid=$jobcardid&mode=$mode");
        }
    }
    ?>
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="vtype" class="form-control" value='<?php echo $vtype; ?>'readonly >
