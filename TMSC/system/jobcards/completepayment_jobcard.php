...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET' && @$mode == 'payment') {
        ...
        $custmeruserid = $row['customeruserid'];
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (empty($grosspayment)) {
            $messages['error_grosspayment'] = "The Gross payment should not be empty...!";
        }
        ...
        if (empty($jobcardstatus)) {
            $messages['error_jobcardstatus'] = "The jobcardstatus should not be empty...!";
        }
        ...
        if (empty($messages)) {
            ...
            $sql = "INSERT INTO tbl_billpayment(jobcardid,serviceid,vehicleid,customeruserid,servicepayment,itemtotalpayment,subservicetotalpayment,grosspayment,servicefreestatus,pendingpayment,adddate,adduser) "
                    . "VALUES ($jobcardid,$serviceid,$vehicleid,$custmeruserid,$servicetotal,$totalitemamount,$subservicetotal,$grosspayment,'$jobcardstatus','$pendingpayment','$adddate','$adduser')";

            $db = dbConn();
            $db->query($sql);

            $sql1 = "UPDATE tbl_jobcards SET jobcardstatus='finished' WHERE jobcardid='$jobcardid'";
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
        ...
        <input type="hidden" name="custmeruserid" value='<?php echo @$custmeruserid; ?>' readonly> 
...
//display voucher image 
        ...
        <div class="card px-md-4 mb-2 my-card-bg">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            $servicetotal = 0;
                            $db = dbconn();
                            $sql = "SELECT sub.subservicename,sub.subserviceprice FROM tbl_jobcardassignserviceslist st INNER JOIN tbl_subservices sub ON sub.subserviceid=st.subserviceid WHERE st.jobcardid=$jobcardid AND st.deletestatus='1' AND sub.deletestatus='1'";
                            $result = $db->query($sql);
                            ...
                            while ($rows = $result->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    if ($jobcardstatus == 'Yes') {
                                        ...
                                        ?>
                                         <input type="hidden" name="pendingpayment" value='<?php echo @$pendingpayment; ?>'> 
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <lable class="form-label">Added service materials list:</lable><br>
            ...
            <div class="row">
                ...
                <div class="col-md-8 fs-6">
                     ...
                     <div class="mb-1">
                        <?php echo "Service package: ".number_format($servicetotal,2) ?> 
                    </div>     
                    <div class="mb-1">
                        <?php echo "Additional services: ". number_format($subservicetotal,2) ?>
                    </div>
                    <div class="mb-1">
                        <?php echo "Materials total:".number_format($totalitemamount,2) ?>
                    </div>
        ...
        <div class="row">
            <div class="col-6">
                ...
                <button type="submit" class="btn card-btn btn-sm mt-2 mb-2">Payment</button>
            </div>
