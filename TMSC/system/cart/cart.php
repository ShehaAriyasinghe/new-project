...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <a href="cart.php?action=empty&jobcardid=<?= $jobcardid ?>">empty</a>
            ...
            foreach ($_SESSION['itemcart'] as $key => $value) {
                ...
                <tr style="border: 1px solid black;">
                    ...
                    <td><?php
                        ...
                        ?></td>
                    <td><a href="cart.php?catalogid=<?= $key; ?>&action=del&jobcardid=<?= $jobcardid ?>"><i class="bi bi-x-square-fill"></i></a></td>
    ...
    <div class="row">
        <div class="col-md-4">
            <a class="btn btn-primary btn-sm mt-1" href="<?= SYSTEM_PATH ?>cart/cart_categoryview.php?mode=assign&jobcardid=<?= $jobcardid ?>">Back to category</a>
        </div>   
        <div class="col-md-4">
            <a class="btn btn-primary btn-sm mt-1" href="<?= SYSTEM_PATH ?>jobcards/assign_materialsjobcard.php?jobcardid=<?= $jobcardid ?>&mode=assign">Back to Job card</a>
        </div>
    </div>
