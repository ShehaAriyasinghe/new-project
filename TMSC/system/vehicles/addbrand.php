...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (!empty($brandname)) {
            ...
            $sql = "SELECT * FROM tbl_brands WHERE brandname='$brandname' AND deletestatus=1";
            $db = dbConn();
            $result = $db->query($sql);
        ...
        if (empty($messages)) {
            ...
            $sql = "INSERT INTO tbl_brands(brandname,adddate,adduser) VALUES ('$brandname','$adddate','$adduser')";
            $db = dbConn();
            $db->query($sql);
            showSuccMeg();
        }
