...
//Check submit
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (empty($messages)) {
            ...
            $sql = "INSERT INTO tbl_centervehicles(color,brandid,modelid,vehicleimage,adddate,adduser) VALUES('$color','$brand','$model','$file_name_new','$adddate','$adduser') ";
            $db = dbconn();
            $db->query($sql);
            showSuccMeg();
        }
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
        ...
        <div class="mb-3 mt-3">
            ...
            <select class="form-select border-dark" name="brand" id="brandid" onchange=loadModel();>  
                <option value="">--</option>
                <?php
