...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Add Item Category</h1>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (!empty($categoryname)) {
            $sql = "SELECT * FROM tbl_itemcategories WHERE categoryname='$categoryname'";
            $db = dbconn();
            $result = $db->query($sql);
        ...
        if (empty($messages)) {
            ...
            $sql = "INSERT INTO tbl_itemcategories(categoryname,adddate,adduser) VALUES ('$categoryname','$adddate','$adduser')";
            $db = dbConn();
            $db->query($sql);
            showSuccMeg();
        }
