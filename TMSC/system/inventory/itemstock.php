        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group me-5">
                <a href="<?= SYSTEM_PATH; ?>inventory/add_itemcatalog.php?categoryid=<?= $categoryid; ?>" type="button" class="btn btn-sm btn-outline-secondary">Add New Catalog</a>
                 <a href="<?= SYSTEM_PATH; ?>inventory/itemcategoriesstock.php" type="button" class="btn btn-sm btn-outline-secondary">View item categories</a>
                ...
                if ($result->num_rows > 0) {
                    while ($rows = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td><a href="add_itemstock.php?catalogid=<?php echo $rows['catalogid'] ?>&categoryid=<?= $categoryid ?>" class="btn card-btn btn-sm">Add Stock</a></td>
                             <td><a href="viewitemstock.php?catalogid=<?php echo $rows['catalogid'] ?>&categoryid=<?= $categoryid ?>" class="btn card-btn btn-sm">View records</a></td>
