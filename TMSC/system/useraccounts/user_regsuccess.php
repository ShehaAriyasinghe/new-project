...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="card my-card-bg">
        <div class="card-header my-card-heading">
            <p class="display-6">Congratulations, the user account has been successfully created.</p>
        </div>
        <div class="card-body">
            <h6 class="">User Name: <?php echo $_SESSION['accountusername']; ?></h6>
            <h6 class="">Job Role: <?php echo ucfirst($_SESSION['useraccountrole']); ?></h6>
            <a href="<?= SYSTEM_PATH; ?>useraccounts/user.php" class="btn btn-primary">All user accounts</a>
        </div>
    </div>
</main>
