...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h6>Voucher Released Payment Report</h6>
...
<?php
    ...
    $db = dbConn();
    $sql = "SELECT sv.servicevoucherid,b.releasedpayment,sv.voucherstatus,b.adddate,sv.vouchercode FROM  tbl_billpayment b LEFT JOIN tbl_servicevoucher sv ON sv.jobcardid=b.jobcardid WHERE b.servicefreestatus='yes' AND sv.deletestatus='1' AND sv.voucherstatus='Released' $where";
    $result = $db->query($sql);
    ?>
        ...
        <table border="1" class="table table-striped">
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td><?= $row['adddate'] ?></td>
                            <td><?= $row['releasedpayment'] ?></td>
                            <td><?= $row['voucherstatus'] ?></td>

                            <?php $total += $row['releasedpayment'] ?>
                ...
                ?>
                <tr>
                    <td colspan="3">Total Released payments:</td>
