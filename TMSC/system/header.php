...
if (!isset($_SESSION['userid'])) {
    header("Location:http://localhost:8080/tmsc/system/login.php");
}
        ...
        <header class="my-nav-bg navbar navbar-dark sticky-top flex-md-nowrap p-0 shadow">
            ...
            <div class="navbar-nav">
                <div class="nav-item text-nowrap">
                    ...
                    <span class='nav-heading'>Welcome, <?php echo $_SESSION['firstname']." ".$_SESSION['lastname'];?></span>
                    <a class="top-0 end-0 nav-heading px-3" href="<?= SYSTEM_PATH; ?>logout.php">Sign out</a>
                </div>
            </div>  
        </header>
