...
//Get bay name,service center start time, lagtime,service center end time
                    ...
                    extract($_POST);
                    if ($_SERVER['REQUEST_METHOD'] == 'POST' && @$operate=="Next") {
                        ...
                        header("Location:checkavailable_timeslots.php?serviceid=$serviceid&servicedate=$servicedate");
                         }
                    ...
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                            ...
                            <select class="form-select border-dark" name="serviceid" id="serviceid" disabled>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <option value="<?php echo $row['serviceid']; ?>" <?php if (@$serviceid == $row['serviceid']) { ?> selected <?php } ?>><?php echo $row['servicename'] . " - Rs." . $row['serviceprice'] . '   ' . "(Time Duration" . '- ' . $time . ')'; ?></option>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" id="servicedate" class="form-control-sm border-dark" onchange="form.submit()" name="servicedate" value="<?= @$servicedate; ?>"  min="<?php echo date("Y-m-d"); ?>">
                        ...
                        <div class="row justify-content-around">
                            <div class="col-4">
                                ...
                                <input type="submit" class="btn btn-primary" value="Next" name="operate">
                            </div>
                            <div class="col-4">
                                <a href="<?= WEB_PATH; ?>" type="submit" class="btn btn-primary">Back</a>
                            </div>
                        </div>
