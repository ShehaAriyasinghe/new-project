...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h6 class="">Completed Job cards</h6>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET' && isset($jobcardid)) {
                ...
                <div class="col-md-6">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            echo "<div class='mb-2'>There are not updated record yet please wait for finish the service..!</div>";
                            }
                            ?>
                        </tbody>
                    </table>
